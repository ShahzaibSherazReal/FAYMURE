...
if ($result->num_rows > 0) {
    ...
    $columns_to_add = [
        ...
        'sort_order' => "ALTER TABLE products ADD COLUMN sort_order INT DEFAULT 0",
        'is_latest_creation' => "ALTER TABLE products ADD COLUMN is_latest_creation TINYINT(1) NOT NULL DEFAULT 0",
